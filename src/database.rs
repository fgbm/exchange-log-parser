...
impl Database {
    ...
    pub async fn insert_smtp_receive_logs(&self, logs: Vec<SmtpReceiveLog>) -> Result<()> {
        let client = self.pool.get().await?;
    ...
    pub async fn insert_smtp_send_logs(&self, logs: Vec<SmtpSendLog>) -> Result<()> {
        let client = self.pool.get().await?;
    ...
    pub async fn insert_message_tracking_logs(&self, logs: Vec<MessageTrackingLog>) -> Result<()> {
        let client = self.pool.get().await?;
